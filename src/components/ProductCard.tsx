...
// {product.onSale && (
//         <div className="mt-2 px-4 text-sm text-gray-600 break-words whitespace-pre-line">
//           {product.description}
//         </div>
//       )}
//     </div>
...
<>
  <div
    className="product-card group relative bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden p-6 cursor-pointer"
    onClick={() => setIsModalOpen(true)}
  >
    {product.onSale && (
      <div className="absolute top-4 left-4 z-10">
