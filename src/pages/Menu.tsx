  ...
  return (
    <div className="min-h-screen pt-24 pb-16">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Conditional Notes */}
        {selectedCategory === "salad" && filteredMenus.length > 0 && (
          <p className="text-green-500 text-xl text-center mb-4">
            Build your own | Extra protein for $2.99
          </p>
        )}

        {selectedCategory === "ice cream" && filteredMenus.length > 0 && (
          <p className="text-green-500 text-xl text-center mb-10">
            $1.99 for 1 Scoop | $3.99 for 3 Scoop
          </p>
        )}

{selectedCategory === "burrito" && filteredMenus.length > 0 && (
          <p className="text-green-500 text-xl text-center mb-10">
            Make it Bowl for $0.99
          </p>
        )}
